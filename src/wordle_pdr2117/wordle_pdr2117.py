def validate_guess(guess, word_length=5):
    ...
    Examples
    --------
    1. validate_guess("crane")
    True
    2. validate_guess("CRANE")
    False
    3. validate_guess("CrAnE")
    False
    4. validate_guess("dog", word_length=3)
    True
    """
...
def check_guess(secret_word, guess):
    ...
    Examples
    --------
    1. check_guess("crane", "crate")
    [('c', 'green'), ('r', 'green'), ('a', 'green'), ('t', 'gray'), ('e', 'green')]
    2. check_guess("robot", "floor")
    [('f', 'gray'), ('l', 'gray'), ('o', 'yellow'), ('o', 'yellow'), ('r', 'yellow')]
    """
